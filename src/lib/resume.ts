...
export const englishResumeData: ResumeData = {
  personalInfo: {
    ...
    website: "www.maximowehncke.com",
    summary: `Software Engineering student at Instituto Tecnológico de Buenos Aires (ITBA), 
		expected graduation December 2027. Focused on backend systems, networking, and cloud-deployed 
		infrastructure — REST APIs, authentication, operating systems, and networking fundamentals — 
		with projects ranging from a REST API built with Java and Spring to a SOCKS5 proxy and a 
		custom OS kernel built from scratch in C. Personal projects deployed on Vercel with a 
		self-managed domain (Cloudflare). Currently pursuing an AI Agent Developer certification 
		at ITBA, focused on designing agentic workflows and system integrations.`,
  },
  skills: [
    "Backend API design & authentication (REST, JWT)",
    "Networking fundamentals (SOCKS5 proxy server in C, POSIX I/O multiplexing)",
    "Operating systems (Linux/Unix) — custom OS kernel in C",
    "Java, Go, TypeScript, Python, Ruby, C",
    "Spring Boot / Spring Security",
    "Cloud deployment (Vercel), domain/DNS management (Cloudflare)",
  ...
  hobbies: ["Skiing", "Volleyball", "Guitar / drums"],
  experience: [
    {
      role: "Object Oriented Programming (OOP) Assistant",
      company: "ITBA",
      ...
      period: "August 2024 – Present",
      bullets: [
        "Guide students with basic and intermediate Java and Ruby programming tasks.",
        "Clarify object-oriented concepts like inheritance, encapsulation, and polymorphism.",
        "Help debug and review students' code submissions.",
      ],
    },
  ...
  education: [
    {
      ...
      institution: "Instituto Tecnológico de Buenos Aires (ITBA)",
      location: "Buenos Aires, Argentina",
      period: "March 2022 – December 2027 (expected)",
    },
    {
      degree: "AI Agent Developer Certification",
      institution: "Instituto Tecnológico de Buenos Aires (ITBA)",
      location: "Buenos Aires, Argentina",
      period: "September 2026 – December 2026 (in progress)",
    },
    {
      degree: "Exchange Semester",
      institution: "Politecnico di Torino",
...
export const spanishResumeData: ResumeData = {
  personalInfo: {
    ...
    Enfocado en sistemas backend, redes e infraestructura. Proyectos que van desde una API REST desarrollada con Java y 
		Spring hasta un proxy SOCKS5 y un kernel de sistema operativo hecho desde cero en C. 
		Proyectos personales desplegados en Vercel con dominio propio (Cloudflare). Actualmente 
		cursando la certificación de Desarrollador de Agentes de IA en el ITBA, enfocada en el 
		diseño de workflows agénticos e integraciones de sistemas.`,
  },
  skills: [
    "Diseño de APIs backend y autenticación (REST, JWT)",
    "Fundamentos de redes (proxy SOCKS5 en C, multiplexación de I/O POSIX)",
    "Sistemas operativos (Linux/Unix) — kernel de sistema operativo propio en C",
    "Java, Go, TypeScript, Python, Ruby, C",
    "Spring Boot / Spring Security",
    "Despliegue en la nube (Vercel), gestión de dominio/DNS (Cloudflare)",
    "PostgreSQL, diseño de bases de datos relacionales",
    "Comunicación técnica clara para distintos tipos de audiencia",
  ],
  interests: [
    "Sistemas backend y programación de redes",
    "Infraestructura y despliegue en la nube",
    "Agentes de IA y workflows agénticos",
  ],
  languages: [
  ...
  hobbies: ["Esquí", "Vóley", "Guitarra / batería"],
  experience: [
    {
      role: "Ayudante de Cátedra de Programación Orientada a Objetos (POO)",
      company: "ITBA",
      location: "Buenos Aires, Argentina",
      period: "Agosto 2024 – Presente",
      bullets: [
        "Guiar a estudiantes en trabajos de programación en Java y Ruby de nivel básico e intermedio.",
  ...
  education: [
    {
      ...
      institution: "Instituto Tecnológico de Buenos Aires (ITBA)",
      location: "Buenos Aires, Argentina",
      period: "Marzo 2022 – Diciembre 2027 (estimado)",
    },
    {
      degree: "Certificación de Desarrollador de Agentes de IA",
      institution: "Instituto Tecnológico de Buenos Aires (ITBA)",
      location: "Buenos Aires, Argentina",
      period: "Septiembre 2026 – Diciembre 2026 (en curso)",
    },
    {
